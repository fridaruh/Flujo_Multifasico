...
with col1:
    ...
    H2S = st.number_input('H2S')
    CO2 = st.number_input('CO2')
    N2 = st.number_input('N2')
    C1 = st.number_input('C1')
    C2 = st.number_input('C2')
    C3 = st.number_input('C3')
    iC4 = st.number_input('iC4')
    nC4= st.number_input('nC4')
    iC5 = st.number_input('iC5')
    nC5 = st.number_input('nC5')
...
with col2:
    st.text('')
    st.text('')
    p_C7 = st.number_input('p C7+')
    pm_c7 = st.number_input('PM C7+')
    C2_C6 = st.number_input('C2 - C6')
    p_mprom = st.number_input('P mprom')
    pi = st.number_input('Pi (Kg/cm2)')
    ty = st.number_input('Ty (°C)')
    prof = st.number_input('Prof (mbnm)')
    pb_pr = st.number_input('Pb/Pr (kg/cm2)')
    bob = st.number_input('Bob (m3/m3)/zn@Pb')
    rsb = st.number_input('Rsb (m3/m3)/ (porc cond max)')
    rga = st.number_input('RGA (m3/m3)')
    po_ce = st.number_input('po @ ce (gr/cm3)')
